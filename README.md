...
Desarrollado por el **Grupo 1** del curso **Metodologías de Desarrollo de Software - 2025-II**.
...
El proyecto tiene como objetivo digitalizar y optimizar el proceso de tutorías académicas, permitiendo a docentes (tutores), estudiantes (tutorados) y personal administrativo gestionar sesiones, asignaciones, reportes y seguimiento de manera eficiente y centralizada.
...
- **Manejo de Archivos:** Multer (almacenamiento en BD como `BYTEA`)  
